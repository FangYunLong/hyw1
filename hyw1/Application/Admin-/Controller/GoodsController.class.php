...
class GoodsController extends BaseController {
    ...
    */
    ...
    public function addEditGoods()
    {
        if (IS_POST) {
            $data = I('post.');
           // dump(isset($_POST['goods_id']));exit;
        ...
        //
        $goods_id = I('get.id');
        $goodsInfo = M("Goods")->field('goods_id,pinpai,dunwei,menjia,mj_height,shuju,goods_name,shoujia,chejia,yajin,khdzj,dcj,cb,bzzj,hdccj,chexing,chezhong,cart_age,huoqi,description,use_hours,dcsj')->where(array('goods_id'=>$goods_id))->find();
        $cat_list = M('CartArt')->select(array('index'=>'id'));
        //$child_id = array();
        ...
        //$type = empty($_POST['goods_id']) ? 2 : 1; // 标识自动验证时的 场景 1 表示插入 2 表示更新
        //dump($_POST['goods_id']);
        //ajax提交验证
