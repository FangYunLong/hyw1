...
function getAllMenu(){
	return	array(
			...
			'goods' => array('name' => '叉车管理', 'icon'=>'fa-book', 'sub_menu' => array(
					array('name' => '叉车属性分类', 'act'=>'categoryList', 'control'=>'Goods'),
	...
	/*		'promotion' => array('name' => '促销管理', 'icon'=>'fa-bell', 'sub_menu' => array(
		...
		/*	'Ad' => array('name' => '广告管理', 'icon'=>'fa-flag', 'sub_menu' => array(
            ...
            'xiaoxi' => array('name' => '消息管理', 'icon'=>'fa-plug', 'sub_menu' => array(
                ...
                array('name' => '发布消息', 'act'=>'addMsg', 'control'=>'Msg'),
            )),
...
*/
            ...
            'gudong' => array('name' => '股东后台', 'icon'=>'fa-plug', 'sub_menu' => array(
                    array('name' => '订单管理', 'act'=>'', 'control'=>'Order'),
                    array('name' => '密码修改', 'act'=>'forgivepw', 'control'=>'User'),
                    array('name' => '代理商管理', 'act'=>'', 'control'=>''),
            )),
            'siji' => array('name' => '司机求职', 'icon'=>'fa-plug', 'sub_menu' => array(
                array('name' => '求职列表', 'act'=>'', 'control'=>'Order'),
            )),
...
function fileUpload($path){
    ...
    $upload->rootPath  =      'http://hyw.web66.cn:8090/Public/Uploads/'.$path; // 设置附件上传目录
    // 上传文件
    $info   =   $upload->upload();
    if(!$info) {
        // 上传错误提示错误信息
