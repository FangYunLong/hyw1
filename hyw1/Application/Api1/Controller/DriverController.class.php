...
class DriverController extends BaseController {
    ...
    */
    public function driverInfo()
    {
        ...
        $res   = M('Resume')->field('user_id,user_name,age,jingyan,city,xueli,is_hidden')->where($data)->page($num,$rows)->select();
        if ($res)
    ...
    public function driverDetailedInfo()
    {
        $data = I('post.');
        $data['_logic'] = 'AND';
        $res = M('Resume')->field('user_name,sex,age,jingyan,xueli,mobile,address')->where($data)->select()[0];
