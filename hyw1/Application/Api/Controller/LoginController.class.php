 ...
 */
    ...
    */
    ...
    public function userlogin ()
    {
        ...
        $order_type = isset($_POST['order_type']) ? $data['order_type'] : '';
        ...
        if($user['level_id'] > 2){
            json_App(['status'=>-1,'msg'=>'身份异常，只有车主和客户身份能登录']);
        }
        ...
        if(!$user){
            ...
            $result = array('status' =>-1,'msg'=>'账号已被冻结，请联系平台！');
        }else{
            //查询用户信息之后, 查询用户的登记昵称
            ...
            $res    = array(
                ...
                'jpush_status' => $user['jpush_status'],
                );
            ...
            $UsersData['order_type'] = $order_type;
            ...
            if($user['identifier']!=$data['identifier']||empty($user['identifier'])){
                ...
                if($user['identifier']!=$data['identifier']&&!empty($user['identifier'])){
                    ...
                    $type = array('type'=>1);
                    Jpush($user['user_id'],$type,'',$content,true);
    ...
    public function user_register()
    {
        ...
        if ($level_id==2) {
            ...
            if ($_FILES['file']['size']>0){
                ...
                json_App(['status'=>-1,'msg'=>'图片大小'.$_FILES['file']['size']]);
                //没有上传文件
        ...
        $map['gongsi']     = I('post.gongsi');             //公司名称
           // exit(json_encode(array('status'=>-1,'msg'=>$map['gongsi'])));
