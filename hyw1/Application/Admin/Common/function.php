...
function getAllMenu(){
	return	array(
			'system' => array('name'=>'系统设置','icon'=>'fa-cog','sub_menu'=>array(
					...
					array('name'=>'广告设置','act'=>'ad','control'=>'System'),
            ...
            'gudonga' => array('name' => '股东后台', 'icon'=>'fa-user', 'sub_menu' => array(
               // array('name' => '订单管理', 'act'=>'', 'control'=>'Order'),
                ...
                array('name' => '服务网络管理', 'act'=>'agent', 'control'=>'Shareholder'),
			...
			'cate' => array('name' => '分类管理', 'icon'=>'fa-book', 'sub_menu' => array(
					array('name' => '类名管理', 'act'=>'categoryList', 'control'=>'Goods'),
					array('name' => '一级分类', 'act'=>'level1', 'control'=>'Goods'),
                    array('name' => '二级分类', 'act'=>'level2', 'control'=>'Goods'),
                    array('name' => '吨位管理', 'act'=>'level3', 'control'=>'Goods'),
			)),			
			'goods' => array('name' => '叉车管理', 'icon'=>'fa-book', 'sub_menu' => array(
					// array('name' => '分类管理', 'act'=>'categoryList', 'control'=>'Goods'),
					array('name' => '叉车参数', 'act'=>'paramList', 'control'=>'Goods'),
                    array('name' => '叉车列表', 'act'=>'goodsList', 'control'=>'Goods'),
                    array('name' => '优惠列表', 'act'=>'preferList', 'control'=>'Goods'),
			...
			'order' => array('name' => '订单管理', 'icon'=>'fa-money', 'sub_menu' => array(
                    ...
                    array('name' => '支付记录', 'act'=>'pay', 'control'=>'Order'),
					// array('name' => '特价车支付记录', 'act'=>'pays', 'control'=>'Order'),
		...
		/*	'weixin' => array('name' => '微信管理', 'icon'=>'fa-weixin', 'sub_menu' => array(
			...
			'count' => array('name' => '统计报表', 'icon'=>'fa-signal', 'sub_menu' => array(
              ...
              /*      array('name' => '订单统计', 'act'=>'', 'control'=>'Report'),
                ...
                array('name' => '租车统计', 'act'=>'car_rental_record', 'control'=>'Report'),
