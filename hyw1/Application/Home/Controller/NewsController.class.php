...
class NewsController extends BaseController {
    ...
    public function articleList()
    {
       ...
       $art_cate['parent_id'] = 1;
       //资讯中心二级分类
       $art_cate = M('ArticleCat')->alias('ac')->join('tp_article as a on ac.cat_id = a.cat_id')->where($art_cate)->order('ac.sort_order ASC')->group('ac.cat_name')->limit(6)->select();
    ...
    public function about()
    {
        ...
        $about_cate['parent_id'] = 4;
        $about_cate = M('ArticleCat')->alias('ac')->join('tp_article as a on ac.cat_id = a.cat_id')->where($about_cate)->order('ac.sort_order ASC')->group('ac.cat_name')->limit(6)->select();
        $this->assign('about_cate',$about_cate);
