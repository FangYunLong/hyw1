...
class OrderController extends BaseController {
    ...
    {
        // $liste = getAction('Index');
        // $liste = getController('Admin');
        // dump($liste);exit;
    ...
    */
    ...
    public function matching()
    {
        ...
        // $num = M('OrderInfo')->field('COALESCE(SUM(paly_num),0) as num')->where($data)->select()[0]['num'];
        // M('OrderInfo')->find();
        $data['id'] = I('post.id');
        $res = M('OrderInfo')->save($data);
    ...
    public function matchOrder()
    {
        ...
        // $content = '您有订单匹配成功，点击查看详情！';
        // $content1 = $Order['order_sn'].'订单匹配成功！';        
        // Jpush(2612,$type,$content,$content1,true);exit;
        $order_id = I('order_id');
        if(!$order_id){
            $this->error('没有该订单！');
