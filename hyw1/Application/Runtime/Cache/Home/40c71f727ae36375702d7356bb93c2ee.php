...
try {
 ...
 <!--    <div class="neiBanner"><img src="/Public/images/neibn8.jpg" width="1198" height="296" /></div> -->
    <div class="neiBanner"><a href="<?php echo ($ad["ad_link"]); ?>"><img src="<?php echo ($ad["ad_code"]); ?>" width="1198" height="296" /></a></div>
    <div class="neiNav">
    <ul class="navlist">
     <li><a href="<?php echo U('News/news');?>" class="current">文章详情</a></li>
    </ul>
   </div>
</div>
...
<div class="neiCent2">
  <div class="xinwen">
    <div class="xinbit">
        <?php if(is_array($articleInfo)): foreach($articleInfo as $k=>$v): ?><div class="newtit"><?php echo ($v['title']); ?></div>
      <div class="newtime">发布时间：<?php echo (date("Y-m-d",$v['add_time'])); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;来源：<?php echo ($v['cat_name']); ?> &nbsp;&nbsp;&nbsp;&nbsp;阅读次数：<?php echo ($v['click']); ?></div>
    </div>
    <div class="xinCent">
        <?php echo (htmlspecialchars_decode($v['content'])); endforeach; endif; ?>
    <div class="fanhui"><a href="javascript:history.go(-1)">返回 >></a></div>
    <div class="shanp">
      <div class="shang1">上一篇：<a href='<?php echo U("Home/News/article_Info/article_id/$fid");?>'><?php echo ($front["title"]); ?></a></div>
      <div class="shang1">下一篇：<a href="<?php echo U('Home/News/article_Info/article_id/'.$aid);?>"><?php echo ($after["title"]); ?></a></div>
    </div>
  </div>
</div>
    <!------底部开始------------>
